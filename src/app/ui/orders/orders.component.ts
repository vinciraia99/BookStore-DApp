...
export class OrdersComponent {
  ...
  convertEpochToItalianDateString(isbn: string): string {
    const epoch = this.bookBuyedList
    ...
    const formattedTime = `alle ore ${hours}:${minutes}`;
    return `Acquistato in data ${formattedDate} ${formattedTime}`;
  }
